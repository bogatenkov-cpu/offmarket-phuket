  ...
  return (
    <section className="bg-gray-50 min-h-screen">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <Link href="/ru/properties" className="text-sm text-emerald-600 hover:text-emerald-700 font-medium">
          {t.back}
        </Link>
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white rounded-2xl p-6 border border-gray-100">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
                {[
                  [t.area, `${p.area_sqm} м²`],
                  [t.bedrooms, p.bedrooms === 0 ? "Студия" : `${p.bedrooms}`],
                  [t.floor, p.floor],
                  [t.yearBuilt, `${p.year_built}`],
                  [t.condition, p.condition],
                  [t.dealType, p.deal_type],
                  [t.furnished, p.furnished || "Нет"],
                  [t.seller, p.seller],
                ].map(([label, value]) => (
